...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> getEventsAndScheduleReminders(String userId) async {
    ...
    for (var event in events) {
      ...
      // Calculate reminder dates (1 day before event date) at 12:00 AM and 11:00 AM
      DateTime reminderDateMidnight = eventDate
          .subtract(Duration(days: 1))
          .add(Duration(hours: 2, minutes: 0));
      DateTime reminderDateMorning = eventDate
          .subtract(Duration(days: 1))
          .add(Duration(hours: 11, minutes: 58));
      ...
      // Schedule notifications
      await scheduleNotification(eventName, eventDate, scheduledDateMidnight);
      await scheduleNotification(eventName, eventDate, scheduledDateMorning);
    }
  }
  ...
  Future<void> sendImmediateNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(
      ...
      'This is an immediate notification', // Body
      platformChannelSpecifics,
    );
  }

  Future<void> scheduleNotification(
      String eventName, DateTime eventDate, tz.TZDateTime reminderDate) async {
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'your channel id',
      'your channel name',
      importance: Importance.max,
